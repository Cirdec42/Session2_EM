...
namespace TestTravailPratique2
{
    ...
    {
        public static string m_version = "Correcteur H23.1.2";
        ...
        ///-------------------------------------------------------------------------------
        /// <summary>
        /// Test des valeurs limites pour l'accesseur en écriture de la propriété Luminosité
        ///</summary>
        [TestMethod()]
        public void T08_MI_LuminositéÉcritureLimites()
        {
            m_maxScore += 2;
            int pts = 0;
            ...
            try
            {
                ModeImage target = new ModeImage("", 0, 0, 0, 0, 0);
                target.Luminosité = -1;
            }
            catch (ArgumentOutOfRangeException)
            {
        ...
        ///-------------------------------------------------------------------------------
        /// <summary>
        /// Test des valeurs limites pour l'accesseur en écriture de la propriété Contraste
        ///</summary>
        [TestMethod()]
        public void T09_MI_ContrasteÉcritureLimites()
        {
            m_maxScore += 2;
            int pts = 0;
        ...
        ///-------------------------------------------------------------------------------
        /// <summary>
        /// Test des valeurs limites pour l'accesseur en écriture de la propriété Couleur
        ///</summary>
        [TestMethod()]
        public void T10_MI_CouleurÉcritureLimites()
        {
            m_maxScore += 2;
            int pts = 0;
        ...
        ///-------------------------------------------------------------------------------
        /// <summary>
        /// Test des valeurs limites pour l'accesseur en écriture de la propriété Teinte
        ///</summary>
        [TestMethod()]
        public void T11_MI_TeinteÉcritureLimites()
        {
            m_maxScore += 2;
            int pts = 0;
        ...
        ///-------------------------------------------------------------------------------
        /// <summary>
        /// Test des valeurs limites pour l'accesseur en écriture de la propriété Netteté
        ///</summary>
        [TestMethod()]
        public void T12_MI_NettetéÉcritureLimites()
        {
            m_maxScore += 2;
            int pts = 0;
        ...
        ///</summary>
        [TestMethod()]
        public void T13_TV_ConstructeurSansParam()
        {
            m_maxScore += 4;
        ...
        ///</summary>
        [TestMethod()]
        public void T15_TV_AugmenterVolume()
        {
            m_maxScore += 2;
            Téléviseur target = new Téléviseur();
            target.Sourdine = true;
        ...
        ///</summary>
        [TestMethod()]
        public void T16_TV_DiminuerVolume()
        {
            m_maxScore += 2;
            Téléviseur target = new Téléviseur();
        ...
        ///</summary>
        [TestMethod()]
        public void T17_TV_AugmenterCanal()
        {
            m_maxScore += 2;
            Téléviseur target = new Téléviseur();
        ...
        ///</summary>
        [TestMethod()]
        public void T18_TV_DimninuerCanal()
        {
            m_maxScore += 2;
            Téléviseur target = new Téléviseur();
        ...
        ///</summary>
        [TestMethod()]
        public void T19_TV_PasserAuDeuxièmeMode()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T20_TV_PasserAuTroisièmeMode()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T21_TV_RetourAuPremimerMode()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T22_TV_Constructeur2Params()
        {
            m_maxScore += 4;
        ...
        ///</summary>
        [TestMethod()]
        public void T23_TV_Constructeur2ParamsLimiteCanal()
        {
            m_maxScore += 3;
            int pts = 0;
            Téléviseur target;
        ...
        ///</summary>
        [TestMethod()]
        public void T24_TV_Constructeur2ParamsLimiteVolume()
        {
            m_maxScore += 3;
            int pts = 0;
            Téléviseur target;
        ...
        ///</summary>
        [TestMethod()]
        public void T25_TV_AugmenterVolumeLimite()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T26_TV_DiminuerVolumeLimite()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T27_TV_AugmenterCanalLimite()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T28_TV_DiminuerCanalLimite()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T29_TV_Constructeur4Params()
        {
            m_maxScore += 5;
        ...
        ///</summary>
        [TestMethod()]
        public void T30_TV_Constructeur4ParamsLimiteCanal()
        {
            m_maxScore += 3;
            int pts = 0;
            Téléviseur target;
        ...
        ///</summary>
        [TestMethod()]
        public void T31_TV_Constructeur4ParamsLimiteVolume()
        {
            m_maxScore += 3;
            int pts = 0;
            Téléviseur target;
        ...
        ///</summary>
        [TestMethod()]
        public void T32_TV_Constructeur4ParamsLimiteIndexSource()
        {
            m_maxScore += 3;
            int pts = 0;
            Téléviseur target;
        ...
        ///</summary>
        [TestMethod()]
        public void T33_TV_Constructeur4ParamsLimiteIndexModeImage()
        {
            m_maxScore += 3;
            int pts = 0;
            Téléviseur target;
        ...
        ///</summary>
        [TestMethod()]
        public void T34_Frm_ÉtatInitial()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T35_Frm_ModifierLaSource()
        {
            m_maxScore += 2;
            FrmPrincipal target = new FrmPrincipal();
            target.Show();
        ...
        ///</summary>
        [TestMethod()]
        public void T36_Frm_PasserAuProchainMode()
        {
            m_maxScore += 2;
        ...
        ///</summary>
        [TestMethod()]
        public void T37_Frm_MémoriserLesAjustements()
        {
            m_maxScore += 1;
            FrmPrincipal target = new FrmPrincipal();
        ...
        ///</summary>
        [TestMethod()]
        public void T38_Frm_AugmenterDiminuerVolume()
        {
            m_maxScore += 1;
            FrmPrincipal target = new FrmPrincipal();
        ...
        ///</summary>
        [TestMethod()]
        public void T39_Frm_AugmenterDiminuerCanal()
        {
            m_maxScore += 1;
            FrmPrincipal target = new FrmPrincipal();
        ...
        ///</summary>
        [TestMethod()]
        public void T40_Frm_ModifierLétatDeLaSourdine()
        {
            m_maxScore += 1;
            FrmPrincipal target = new FrmPrincipal();
